...
class Database:
    ...
    async def get_bandwidth_stats(self) -> dict:
        ...
        try:
            ...
            for i in range(7):
                ...
                weekly_days[d] = {"date": d, "bytes": 0, "streams": 0}
            ...
            top_content_week = [{"title": r["_id"], "bytes": r["bytes"], "streams": r["streams"]} for r in top_content_week_raw]
    ...
    async def create_member_otp(self, user_id: int, username: str,
        ...
        pass_hash = _hashlib.sha256(otp_pass.encode()).hexdigest()
    ...
    async def verify_member_otp(self, username: str, password: str) -> Optional[dict]:
        ...
        pass_hash = _hashlib.sha256(password.encode()).hexdigest()
